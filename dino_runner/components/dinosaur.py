import pygame
from dino_runner.utils.constants import (DEAD,RUNNING, RUNNING_SHIELD,RUNNING_HAMMER ,DUCKING,DUCKING_HAMMER ,DUCKING_SHIELD, JUMPING,JUMPING_HAMMER ,JUMPING_SHIELD,
